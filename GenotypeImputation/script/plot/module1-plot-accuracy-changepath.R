...
# 286698
Reduce(intersect,list(ds.VN916_1KGP$ID, ds.VN916_SG10K$ID, ds.SG10K$ID, ds.VN916$ID, ds.1KGP$ID,gt.vn94$ID)) -> m
#Reduce(intersect,list(ds.1kgp$ID, ds.vn920$ID, ds.sg10k$ID, gt.vn94$ID)) -> m
#### test accuracy ####
print(mat)
r2_VN916_1KGP <- test_accuracy(mat, ds.VN916_1KGP, MAF_1KGP3)
r2_VN916_SG10K <- test_accuracy(mat, ds.VN916_SG10K, MAF_1KGP3)
r2_SG10K <- test_accuracy(mat, ds.SG10K, MAF_1KGP3)
r2_1KGP <- test_accuracy(mat, ds.1KGP, MAF_1KGP3)
r2_VN916 <- test_accuracy(mat, ds.VN916, MAF_1KGP3)

#### plot accuracy ####
p3 <- plot_accuracy(x=ls(pattern="r2_"), output="images/accuracy_5-ref-panel_KHV.pdf")
